<div id="sidebar" class="col-sm-2 col-sm-offset-1">
    ...
    <h1>Official upnext.fm script repository and API documentation.</h1>
    <ul>
        ...
        <li{% if active_sidebar_item == "installing" %} class="active"{% endif %}>
            <a href="installing.html">How To Install Scripts</a>
        </li>
        <li{% if active_sidebar_item == "docs" %} class="active"{% endif %}>
            ...
            <a href="docs.html#topic-properties" class="docs-tc-root">Properties</a>
            <ul>
                <li><a href="docs.html#topic-properties-version">$api.version</a></li>
            </ul>

            <a href="docs.html#topic-api-methods" class="docs-tc-root">Methods</a>
            <ul>
            ...
            <a href="docs.html#topic-api-events" class="docs-tc-root">Events</a>
            <ul>
            ...
            <a href="docs.html#topic-examples" class="docs-tc-root">Examples</a>
            <ul>
